import {ChallengeGroupPagingParams} from "@/_challenge-group/api/challenge.group.request.ts";
import {useSearchParams} from "react-router-dom";
import {useSuspenseQuery} from "@tanstack/react-query";
import {PagingResponse} from "@/global/api/ApiResonpse.ts";
import {ApiError} from "@/global/api/ApiError.ts";
import {CHALLENGE_REVIEW} from "@/global/const/query.key.ts";
import {useEffect} from "react";
import {ChallengeReviewModel} from "@/_challenge-review/api/challenge.review.response.ts";
import {getChallengeReviewPaging} from "@/_challenge-review/api/challenge.review.api.ts";
